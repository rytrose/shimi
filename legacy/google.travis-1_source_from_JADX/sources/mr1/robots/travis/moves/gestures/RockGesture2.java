...
public class RockGesture2 extends TravisGesture implements TravisDofs {
    ...
    public RockGesture2() {
        ...
        tempMoves.add(new GestureParameter(TravisDofs.NECKRL_MOTOR, 0.2f, 0.5f, Arrays.asList(new Float[]{Float.valueOf(0.4f), Float.valueOf(0.7f), Float.valueOf(0.9f), Float.valueOf(1.0f), Float.valueOf(1.0f), Float.valueOf(1.0f)})));
        ...
        beatMap.put(Float.valueOf(0.0f), tempMoves);
        tempMoves = new ArrayList();
        tempMoves.add(new GestureParameter(TravisDofs.NECKRL_MOTOR, -0.2f, 0.5f, Arrays.asList(new Float[]{Float.valueOf(0.7f), Float.valueOf(0.9f), Float.valueOf(1.0f), Float.valueOf(1.0f), Float.valueOf(1.0f)})));
        beatMap.put(Float.valueOf(0.5f), tempMoves);
