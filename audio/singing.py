...
class PVSample:
    ...
    def __init__(self, path, balance=None):
        ...
        Args:
            path: A string path to the audio file to play.
            balance: A pyo object to balance the RMS of this sample player with.
        """
        PVSIZE = 1024
        PVOLAPS = 4
    ...
    def set_speed(self, val):
        ...
        Args:
            val: A float frequency to playback the sample at. Does not change pitch.
        """
    ...
    def set_phase(self, val):
        ...
        Args:
            val: A float between 0.0 and 1.0 where 0 is the beginning of the sample, and 1 is the end.
        """
...
class Singing:
    def __init__(self, init_pyo=False, duplex=False, resource_path="/home/nvidia/shimi/audio"):
        ...
        Args:
            init_pyo: A boolean that determines whether or not to start pyo.
            duplex: A boolean that determines whether or not to use microphone input (True) or not (False).
            resource_path: A string path to directory containing singing files.
        """
        self.duplex = duplex
    ...
    def audio_initialize(self, audio_path, extraction_type="cnn", extraction_file=None):
        ...
        Args:
            audio_path: A string path to audio file to sing and play.
            extraction_type: A string either "cnn" or "melodia" determining the melody extraction model.
            extraction_file: An optional string path to the a melody extraction output data file to use.
        """
        ...
        self.shimi_sample = PVSample(self.shimi_vocal_path, balance=self.vocal_filter)
    ...
    def set_freq(self):
        ...
        if self.frequency_index == len(self.melody_data) - 1:  # Stop sample playback, otherwise it will loop forever
    ...
    def sing_audio(self, audio_path, extraction_type, extraction_file=None, starting_callback=None, blocking=False):
        ...
        Args:
            audio_path: A string path to the audio file to be played.
            extraction_type: A string either "cnn" or "melodia" determining the melody extraction model.
            extraction_file: An optional string path to the a melody extraction output data file to use.
            starting_callback: An optional function to call when singing playback starts. Can be used to start getsure.
            blocking: A boolean that determines whether or not this function should wait for playback to finish to return.
        """
    ...
    def sing_midi(self, midi_path):
        ...
        Args:
            midi_path: A string path to the MIDI file to be sung.
        """
